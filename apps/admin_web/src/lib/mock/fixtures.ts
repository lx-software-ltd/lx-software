...
export const boardTasksFixture: BoardTask[] = [
  ...
  fixtureTask("task-catalog", "awaiting_import", "content-marketer", "Founder directive — CATALOG MICRO-BATCH Eastern.", {
    deliverableType: "json",
    origin: "duty",
    managerId: "cmo",
    eventRef: { kind: "catalog-micro-batch", id: "catalog:eastern", districtId: "eastern", district: "Eastern" },
    importPhase: "pending",
    acceptedAt: isoDaysAgo(0),
    importPreview: {
      ok: true,
      taskId: "task-catalog",
      district: "Eastern",
  ...
  fixtureTask("task-catalog-invalid", "needs_owner", "content-marketer", "Founder directive — CATALOG MICRO-BATCH Islands.", {
    deliverableType: "json",
    origin: "duty",
    managerId: "cmo",
    importPhase: "invalid",
    revalidateAttempts: 3,
    eventRef: { kind: "catalog-micro-batch", id: "catalog:islands-parked", districtId: "islands", district: "Islands" },
    openQuestions: ["automatic re-validation stopped after 3 attempts; Preview or Requeue to try again"],
    importPreview: {
      ok: false,
      taskId: "task-catalog-invalid",
      district: "Islands",
      importEnabled: true,
      configured: true,
      dryRun: {
        ...
        skipped: 0,
        errors: [],
        results: [{ type: "organizations", key: "Discovery Bay Playground", status: "failed" }],
      },
      payload: { organizations: [{ name: "Discovery Bay Playground", category_name: "Outdoor activity", area_name: "Islands" }] },
    },
  }),
  fixtureTask("task-catalog-collision", "needs_owner", "content-marketer", "Founder directive — CATALOG MICRO-BATCH Wan Chai.", {
    ...
    eventRef: { kind: "catalog-micro-batch", id: "catalog:wan-chai", districtId: "wan-chai", district: "Wan Chai" },
    openQuestions: ["siutindei would update existing organisations: Kidz Club"],
    importPreview: {
      ok: true,
      taskId: "task-catalog-collision",
      district: "Wan Chai",
      importEnabled: false,
      configured: true,
      dryRun: {
...
export const boardReviewFixture: BoardReviewSnapshot = {
  ...
  headline: {
    ...
    catalog: { ready: 1, importedDistricts: 6, completeDistricts: 2, nextDistrict: "Islands", failedActivityRows: 0, revalidateExhausted: 1 },
  },
...
export const openrouterUsageFixture: OpenRouterUsagePayload = {
  ...
  pull: {
    ok: true,
    reason: "",
    pulledAt: "2026-09-22T06:00:00Z",
    apps: [
      { id: "evolvesprouts", status: "updated", days: 22 },
      { id: "siutindei", status: "no_usage", days: 0 },
      { id: "or-key:scratch", status: "updated", days: 22 },
      { id: "openrouter-other", status: "updated", days: 22 },
    ],
  },
};
