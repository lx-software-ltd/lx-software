...
export const BOARD_CATALOG_TYPE_TO_CATEGORY = {"playground": "Outdoor activity", "indoor_play": "Indoor fun", "class": "Class", "outdoor": "Outdoor activity", "event": "Workshop"} as const;
