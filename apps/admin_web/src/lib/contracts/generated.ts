...
export const BOARD_STAFF_APPROVAL_EXPIRY_HOURS = 168;
export const BOARD_CATALOG_IMPORT_HOLD_HOURS = 2;
export const BOARD_CATALOG_AUTO_BULK_MIN_APPROVED = 50;
export const BOARD_STAFF_DEFAULT_MODEL_BY_SEAT = {"content-marketer": "qwen/qwen-2.5-72b-instruct"} as const;
...
export const BOARD_CATALOG_NAME_DENY_TOKENS = ["elderly", "\u9577\u8005", "\u5b89\u8001", "kindergarten", "\u5e7c\u7a1a\u5712", "nursery", "\u5e7c\u5152", "tutorial", "\u88dc\u7fd2", "day care", "\u65e5\u9593\u8b77\u7406"] as const;
