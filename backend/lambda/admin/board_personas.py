...
BOOKS_OF_RECORD = (
    "Books of record: this board is Siu Tin Dei. LX Software does not use QuickBooks, "
    "Xero or any other accounting package. Listing receivables (invoices, payments, "
    "subscriptions, D+7 / D+21 / D+35 aging) live in the Siu Tin Dei product database; "
    "members with finance access must call finance_aging_report, finance_list_invoices "
    "and finance_list_subscriptions. Cash on the owner's accounts sheet (all houses, "
    "not product cash) and Siu Tin Dei statement-book income/expenditure totals come from "
    "finance_cash_snapshot (aggregated; no account names). The LX Software statement book "
